...
1. If the password is correct, we will have successfully mounted on the container as a virtual disk `M:`. Double-click on the disk `M:` to open the container.
    ...
    <img src="https://github.com/worldbank/dime-standards/blob/master/dime-research-standards/pillar-4-data-security/data-security-resources/img/vc_mount_6.png" width="50%"><!--- Image is read from master branch or use full URL-->
