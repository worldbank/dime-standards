...
DIME Analytics by email and submitting the [Reproducibility Package Checklist](https://github.com/worldbank/dime-standards/blob/master/dime-research-standards/checklists/reproducibility-package-checklist.pdf).
The team will review the submitted materials and provide [Reproducibility Check Results](https://github.com/worldbank/dime-standards/blob/master/dime-research-standards/checklists/reproducibility-check-result.pdf) in a timely fashion.
