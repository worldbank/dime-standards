...
\begin{document}
  ...
  \textbf{Note:} We are piloting this checklist as part of improving the code review process. The questions in this list are therefore \textbf{not required}, and we welcome your feedback on the points listed below.
    ...
    \item[]{\textbf{Sampling:}
            ...
            \begin{itemize}
                \item[]\dimeCheckBox{The population dataset is uniquely identified.}
        ...
        \item[]{\textbf{Randomization:}}
            ...
            \item[]\dimeCheckBox{The project uses a script to randomize.}
            
            \begin{itemize}
                \item[]\dimeCheckBox{If not, the reason is fully documented.}
            \end{itemize}

             \item[]\dimeCheckBox{The code sets the version of Stata before randomizing.}
            
        
            \item[]\dimeCheckBox{No new observations are created in the randomization section.}

            \item[]\dimeCheckBox{The data is sorted before randomizing.}
            ...
            \item[]\dimeCheckBox{The randomization code is reproducible and consistent across multiple runs. For more information, you can refer to \href{https://osf.io/ys3fv/}{this resource on iedorep}.}
