...
% Set header and footer using fancyhdr
\renewcommand{\headrulewidth}{0pt}

\fancypagestyle{firstpage}{
    \fancyhf{} % Clear existing headers/footers
    \fancyhead[L]{\includegraphics[height=1cm,keepaspectratio]{../../img/wb}} 
    \fancyhead[R]{\includegraphics[height=1cm,keepaspectratio]{../../img/analytics}} 
}

\pagestyle{plain} % Use plain style for all other pages
