...
\begin{document}
	\begin{fullwidth}
        ...
        \textbf{NOTE:} Your deliverable from this exercise will be  \href{https://survey.wb.surveycto.com/collect/code_review_summary?caseid=}{this detailed form} which replicates the checklist below.
