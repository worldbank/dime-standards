...
\titleBox{
	...
	\Large\textbf{{v1.0 - Last updated December 5, 2022}}}
}
...
\section*{How it works}
	...
	\begin{enumerate}
        ...
        \begin{itemize}
            \item As part of this step, teams will identify what tasks they want reviewed (data cleaning, construction, or analysis) and whether they want the reviewer to assess  \textbf{computational reproducibility}. 
       ...
       \item Reviewers review the code using structured checklists:
        ...
        \end{itemize}
         ...
         \item At the end of the week, reviewers submit \href{https://survey.wb.surveycto.com/collect/code_review_summary?caseid=}{a structured feedback form} and upload their completed checklists.

         \item \textbf{DIME Analytics} conducts a \textbf{code review summary session} \textbf{(within 3 weeks)} with participants, to discuss summary statistics and general lessons from the recently concluded round of peer code review. TTLs are invited to attend.
	...
	\section{What teams receive}
        ...
        \item \textbf{TTLs} receive \href{https://github.com/worldbank/dime-standards/blob/peer-code-review/dime-coding-standards/checklists/Sample%20TTL%20Report.pdf}{a standardized report} for their project indicating adherence to best practices and areas for improvement \textbf{within 2 weeks}.
        \item \textbf{Research assistants} receive detailed feedback though the \href{https://github.com/worldbank/dime-standards/blob/master/dime-coding-standards/checklists/Reviewer%20Feedback%20Checklist.pdf}{Reviewer Feedback Checklist} submitted by their review partner \textbf{within 2 weeks}.
        \item All participating \textbf{TTLs and DIME Managers} receive a \href{https://github.com/worldbank/dime-standards/blob/peer-code-review/dime-coding-standards/checklists/Sample%20Overall%20Summary%20Report%20.pdf}{summary report} highlighting common strengths and weaknesses \textbf{within 3 weeks}. This is also discussed during the concluding \textbf{code review summary session}.
		\end{itemize}
