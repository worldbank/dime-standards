...
\section*{How it works}
	...
	\section{What teams receive}
        ...
        \item \textbf{TTLs} receive \href{https://github.com/worldbank/dime-standards/blob/peer-code-review/dime-coding-standards/checklists/Sample%20TTL%20Report.pdf}{individual reports} for their projects indicating adherence to best practices, and areas for improvement.
        \item \textbf{Research assistants} receive detailed feedback in the form of the \href{https://github.com/worldbank/dime-standards/blob/master/dime-coding-standards/checklists/Reviewer%20Feedback%20Checklist.pdf}{Reviewer Feedback Checklist} submitted by their code review partners.
