...
\section*{How it works}
	...
	\begin{enumerate}
        ...
        \begin{itemize}
            \item As part of this step, teams should evaluate if they would like to receive comments on \textbf{code reproducibility} and \textbf{output replicability}. 
            \item \textbf{Note} that in this case, teams should prepare a \textbf{de-identified} version of the dataset to include in the submission package.
        \end{itemize}

        \item Participants are then paired for review based on preferred statistical software and length of code.
        ...
        \item The actual peer code review activity takes place over the course of one week, which includes:
         \begin{itemize}
            ...
            \item A \textbf{group work party} with technical support from DIME Analytics. Pairs work together, and answer questions to allow each other to review their submitted code.
        \end{itemize}

        \item Reviewers finally submit feedback using \href{https://survey.wb.surveycto.com/collect/code_review_summary?caseid=}{this form}. They also fill out and submit the following checklists:
        \begin{itemize}
	...
	\section{What teams receive}
        ...
        \item TTLs receive \href{https://github.com/worldbank/dime-standards/blob/peer-code-review/dime-coding-standards/checklists/Sample%20TTL%20Report.pdf}{individual reports} for their projects indicating adherence to best practices, and areas for improvement.
        \item Research assistants receive detailed feedback in the form of the \href{https://github.com/worldbank/dime-standards/blob/master/dime-coding-standards/checklists/Reviewer%20Feedback%20Checklist.pdf}{Reviewer Feedback Checklist} submitted by their code review partners.
        \item Analytics prepares and shares a \href{https://github.com/worldbank/dime-standards/blob/peer-code-review/dime-coding-standards/checklists/Sample%20Overall%20Summary%20Report%20.pdf}{summary report}  for the completed round of peer code review with DIME management, as well as the teams who signed up for the code review round.
		\end{itemize}
