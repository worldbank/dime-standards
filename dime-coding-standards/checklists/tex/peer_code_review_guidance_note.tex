	...
	\begin{enumerate}
       ...
       \item Reviewers review the code using structured checklists:
        ...
        \end{itemize}
         ...
         \item \textbf{DIME Analytics} conducts a \textbf{code review summary session} \textbf{(within 3 weeks)} with RAs, as well as TTLs (optional), to discuss summary statistics and general lessons from the recently concluded round of peer code review.
